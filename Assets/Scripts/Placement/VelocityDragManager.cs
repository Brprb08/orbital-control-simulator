...
//         if (planet == null)
//         {
//             Debug.Log($"[VDM] No planet assigned (id={GetInstanceID()})");
//         }
//         if (trajectoryRenderer == null || planet == null) return;

//         // Use the cached service, not ctx?.BodyService
//         if (bodyService == null || bodyService.CentralBody == null)
//         {
//             Debug.Log("[VDM] No BodyService or CentralBody, skipping preview");
//             return;
//         }
...
//         Debug.Log($"[VDM] QuickPreviewFromState at {planet.transform.position} vel={currentVelocity}");
