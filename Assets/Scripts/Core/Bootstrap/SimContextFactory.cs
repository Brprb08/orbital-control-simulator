...
public static class SimContextFactory
{
    public static SimContext Create(BootstrapReferences references)
    {
        return new SimContext
        {
            ...
            ConstellationRegistry = references.constellationRegistry,
            ConstellationTrajectoryOverlay = references.constellationTrajectoryOverlay,
            ConstellationIndicatorController = references.constellationIndicatorController,
